...
# 1 "./AECUL_Modules/RealTimeClockDS1307/../../AECUL_Modules/UART_LoggingDebugData/UART_LoggingDebugData.h" 1
# 13 "./AECUL_Modules/RealTimeClockDS1307/../../AECUL_Modules/UART_LoggingDebugData/UART_LoggingDebugData.h"
...
uint8_t U4RecValue = 0;
uint8_t U5RecValue = 0;
...
void main(void)
{
    ...
    EEPROM_24C02C_Write_Byte(0xA6, 0x08, 5);
    _delay((unsigned long)((100)*(16000000/4000000.0)));
    EEPROM_24C02C_Write_Byte(0xA2, 0x08, 6);
    _delay((unsigned long)((100)*(16000000/4000000.0)));
    U4RecValue = EEPROM_24C02C_Read_Byte(0xA6, 0x08);
    U5RecValue = EEPROM_24C02C_Read_Byte(0xA2, 0x08);
